...
const HomePageScreen=({ navigation }: { navigation: any })=>{
  ...
  const [currentTab,setCurrentTab] = useState("HomeSc");
  ...
  return(
    <SafeAreaView style={styles.container}>
      <View style={{justifyContent:'flex-start',width:'80%',height:'100%',padding:16,backgroundColor:'#9798d6',borderTopRightRadius:10,borderBottomRightRadius:10}}>
        <Image style={{width:70,height:70,marginLeft:16,borderRadius:50,}} source={require('../assets/icons/avtuser.jpg')}></Image>
        <Text style={{marginLeft:16,fontSize:25, color:'white',fontWeight:'600',fontFamily:'Cochin'}}>Nhi Truong</Text>
        <Separator/>
      ...
      >
        ...
        <View>
          ...
          style={{alignItems:'flex-start', margin:16}}>
            <FontAwesome5 name="bars" size={24} color="#6667AB" tintColor="black"/>
          </TouchableOpacity>
