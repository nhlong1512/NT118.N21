    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View>
          ...
          <View style={{marginBottom:25,marginTop:15,marginLeft:10,alignItems:'center'}}>
            <Text style={{textAlign:'center',color:'#6667AB',fontWeight:'bold',fontSize:28,fontFamily:'Inner'}}>
              CHI TIẾT CÔNG VIỆC
            </Text>
          </View>
          </View>
          ...
          <View style={styles.information}>
            ...
            <View style={{marginLeft:10,}}>
              <Text style={{fontFamily:'Cochin',fontSize:18,color:'#1E1E1E',marginRight:20}}>
          ...
          <View style={styles.information}>
            ...
            <View style={{marginLeft:10,marginTop:10}}>
              <Text style={{fontFamily:'Cochin',fontSize:18,color:'#1E1E1E'}}>
                Full-Time
              </Text>
            </View>
          </View>
